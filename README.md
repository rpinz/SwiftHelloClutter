...
The Swift wrappers have been tested with glib-2.48 and 2.52, and clutter 1.26.  They should work with higher versions, but YMMV.  Also make sure you have `gobject-introspection` and its `.gir` files installed.
